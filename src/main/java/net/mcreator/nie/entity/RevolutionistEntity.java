...
package net.mcreator.nie.entity;
...
import net.mcreator.nie.entity.renderer.RevolutionistRenderer;
import net.mcreator.nie.NieModElements;

@NieModElements.ModElement.Tag
public class RevolutionistEntity extends NieModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.95f)).build("revolutionist").setRegistryName("revolutionist");

	public RevolutionistEntity(NieModElements instance) {
		super(instance, 5);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RevolutionistRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -65536, -205, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("revolutionist_spawn_egg"));
	}
